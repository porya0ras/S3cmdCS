...
namespace s3cmdCS
{
    class Program
    {
        ...
        {
            string accessKey = getSetting("accessKey");
            string secretKey = getSetting("secretKey");

            AmazonS3Config config = new AmazonS3Config();
            config.ServiceURL = getSetting("Endpoint");
       ...
       public static void List(AmazonS3Client client, string bucketName)
        ...
        public static void UploadFile(AmazonS3Client client, string localpath,string bucketName)
        {
            try
            {
                var keyName = Path.GetFileName(localpath);
        ...
        public static string getSetting(string fild)
        {
        ...
        {
            progress.Report((double)e.TransferredBytes / e.TotalBytes);
            // Process event.
        }
    }
}
